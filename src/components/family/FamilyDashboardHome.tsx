  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-5 border-2 border-gray-200">
        ...
        <div className="bg-white rounded-2xl shadow-md p-5 border-2 border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <h3 className="text-lg font-bold text-gray-900">{elderlyProfile.first_name}'s Interests</h3>
            </div>
            <button
          ...
          {interests.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              >
                Add interests for {elderlyProfile.first_name}
              </button>
            </div>
          )}
        </div>
