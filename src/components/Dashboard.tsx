...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F2EE] flex">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:sticky lg:top-0 lg:h-screen ${
